...
import com.library_management.repository.identity.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    public IntrospectResponse introspect(IntrospectRequest request) throws JOSEException, ParseException {
        ...
        log.info("Service: Process to verify token");
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        log.info("Service: Logging in to system");
    ...
    public AuthenticationResponse refreshToken(RefreshRequest request) throws ParseException, JOSEException {
        ...
        var token = generateToken(user);
        log.info("Service: Token is refreshing");
        return AuthenticationResponse.builder()
                .token(token)
                .isAuthenticated(true)
                .build();
    ...
    private SignedJWT verifyToken(String token, boolean isRefresh) throws JOSEException, ParseException {
        ...
        log.info("Service: Verifying token");
        return signedJWT;
    }
    ...
    private String generateToken(User user) {
        ...
        try {
            ...
            log.info("Service: Generating token");
    ...
    private String buildScope(User user) {
        ...
        log.info("Service: Building scope");
